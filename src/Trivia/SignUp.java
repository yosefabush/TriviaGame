...
//      DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd");
    java.util.Date newDate=Calendar.getInstance().getTime();
     private Date date=new Date(newDate.getTime()); //לתקן את תאריך
...
//      
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
          String userName=this.userNameField.getText();
            ...
            //String sql="INSERT INTO triviyadb.tblusers (`"+userId+"`, `"+userName+"`, `"+password+"`) VALUES (6789, 'david', 5555)";
            //String sql="insert into tblusers('"+userId+"','"+userName+"','"+password+"') where a.`Userid`!='"+userId+"'";
        try {
...
//        if(!DataBase.getInstance().GetUser(userName,Password)){ //if the user not found in DB
//            DataBase.getInstance().AddUser(userName,Password);
//            OpenScreen newGame=new OpenScreen();
//            newGame.setVisible(true);
//            this.dispose();
//        }
//                
//        else{
//             JOptionPane.showMessageDialog(this, "The user allredy exist");
//             return;
//        }
